...
def Genereerimise_nupp():
    ...
    raha, aeg = main() # Arvutamine tõstetud main funktsiooni sisse
...
def avaaken():
    ...
    sisesta = ctk.CTkEntry(
        master=test,
        placeholder_text="Siia kirjuta midagi",
        width=200,
        height=30,
        border_width=2,
        corner_radius=10
...
# --- Arvutusakna asjad ---
def arvutusaken():
    # Siin .grid süsteem kasutusel. Laiemalt kasutatav, aga omamoodi keeruline
    ...
    ajaline_summa.grid(row=1, column=1, padx=5, pady=5, sticky="w")
    ...
    "Tähelepanu! Tulemusi arvutatakse edasi-tagasi käiku arvestades. Programmi algoritmid ei pruugi olla täpsed, kasuta omal vastutusel. Loojad ei hüvita vigaseid summasid."
...
def bussi_kulu(soodustus):
    ...
    # ? kas see funktsioon on kusagil reaalselt kasutusel ? võib olla lõhkusin ära ups
...
def joonista_vordlus_graafik(distants_km, valik, auto_kütusekulu_l_100km=None, buss_soodustus=None, buss_aeg_üks_ots=None):
    """Joonistab tabeli + graafiku (kõik täpid).
       Valitud meetod joonistatakse tärniga ja nimeks saab 'Teie valik (<meetod>)'.
       Tabelis ei ole eraldi 'Teie valik' rida."""
    ...
    # Auto: kui pole valitud, kasuta vaikimisi 8 l/100km
    ...
    # --- GRAAFIKU OSA: joonista punktid (valitud on tärn) ---
